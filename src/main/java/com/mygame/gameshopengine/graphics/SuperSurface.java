...
public class SuperSurface {
    ...
    public SuperSurface(String name, SuperLine[] currencyLines, ATMS atms, Node node, Texture2D texture2D){
    ...
    public void flip(String name){
        SuperLine[] temp = new SuperLine[4];

//        if (name.equals("back")) {
//            temp[0] = new SuperLine(new Vector3f[]{currencyLines[0].points[3], currencyLines[1].points[3], currencyLines[2].points[3], currencyLines[3].points[3]}, currencyLines[0].numPoints);
//            temp[1] = new SuperLine(new Vector3f[]{currencyLines[0].points[2], currencyLines[1].points[2], currencyLines[2].points[2], currencyLines[3].points[2]}, currencyLines[0].numPoints);
//            temp[2] = new SuperLine(new Vector3f[]{currencyLines[0].points[1], currencyLines[1].points[1], currencyLines[2].points[1], currencyLines[3].points[1]}, currencyLines[0].numPoints);
//            temp[3] = new SuperLine(new Vector3f[]{currencyLines[0].points[0], currencyLines[1].points[0], currencyLines[2].points[0], currencyLines[3].points[0]}, currencyLines[0].numPoints);
//        } else  if (name.equals("front")) {
//            temp[0] = new SuperLine(new Vector3f[]{currencyLines[3].points[3], currencyLines[2].points[3], currencyLines[1].points[3], currencyLines[0].points[3]}, currencyLines[0].numPoints);
//            temp[1] = new SuperLine(new Vector3f[]{currencyLines[3].points[2], currencyLines[2].points[2], currencyLines[1].points[2], currencyLines[0].points[2]}, currencyLines[0].numPoints);
//            temp[2] = new SuperLine(new Vector3f[]{currencyLines[3].points[1], currencyLines[2].points[1], currencyLines[1].points[1], currencyLines[0].points[1]}, currencyLines[0].numPoints);
//            temp[3] = new SuperLine(new Vector3f[]{currencyLines[3].points[0], currencyLines[2].points[0], currencyLines[1].points[0], currencyLines[0].points[0]}, currencyLines[0].numPoints);
//        } else {
            temp[0] = new SuperLine(new Vector3f[]{currencyLines[0].points[3], currencyLines[1].points[3], currencyLines[2].points[3], currencyLines[3].points[3]}, currencyLines[0].numPoints);
            temp[1] = new SuperLine(new Vector3f[]{currencyLines[0].points[2], currencyLines[1].points[2], currencyLines[2].points[2], currencyLines[3].points[2]}, currencyLines[0].numPoints);
            temp[2] = new SuperLine(new Vector3f[]{currencyLines[0].points[1], currencyLines[1].points[1], currencyLines[2].points[1], currencyLines[3].points[1]}, currencyLines[0].numPoints);
