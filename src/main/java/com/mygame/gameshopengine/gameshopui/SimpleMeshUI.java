...
import com.mygame.gameshopengine.graphics.SimpleGeometry;
import com.mygame.gameshopengine.graphics.SimpleMesh;
...
public class SimpleMeshUI extends SimpleMesh {
    public SimpleMeshUI(SuperSurface s, Vector3f[] vertices, Vector2f[] texCoord, Texture2D texture, Node node) {
        ...
        mat = new Material(App.app.getAssetManager(), "/MatDefs/GameShopUI.j3md");
