...
public class Omni {
    ...
    public void draw(){
        ...
        System.out.println("ATMS " + atms.name);
        pic.setTexture(App.app.getAssetManager(), new Texture2D(atms.makeATMS()), true);
    ...
    public void attachNode(){
        App.app.getGuiNode().attachChild(node);
    }

    public void detachNode(){
        App.app.getGuiNode().detachChild(node);

    }

    public void drawText(){

        BitmapFont guiFont = App.app.getAssetManager().loadFont("/Fonts/GoogleSans.fnt");
       ...
       //}
       // App.app.getGuiNode().attachChild(helloText);
